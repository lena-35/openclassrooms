# 📓 Notes : Initiez-vous à la gestion de projet agile

> **Cours :** https://openclassrooms.com/fr/courses/4507926-initiez-vous-a-la-gestion-de-projet-agile

> **Début du cours :** 30/04/2026

> **Fin du cours :** xx/05/2026

---

## 🧭 Partie 1 : Constituer son équipe agile avec le modèle Tuckman
La constitution de l'équipe est une des étapes les plus importantes de la vie d'un projet. 

### 1.1 Découvrir l'importance de l'esprit d'équipe en gestion de projet agile

### 1.2 Former son équipe

### 1.3 Lancer son travail en équipe

### 1.4 Régulariser le travail de son équipe

### 1.5 Performer en équipe


## 👤  Partie 2 : Prendre en compte le besoin des utilisateurs

### 1.1 Collecter les besoins

### 1.2 Cartographier le projet

### 1.3 Mener des entretiens

### 1.4 Créer des personas

### 1.5 Résumer l'UX du projet en créant un story-board


## 🖼️ Partie 3 : Utiliser des outils visuels de gestion de projet agile

### 1.1 Inspecter les User Stories

### 1.2 Évaluer le Product Backlog

### 1.3 Estimer la complexité d'un projet

### 1.4 Utiliser la méthode Kanban

### 1.5 Éviter les gaspillages grâce au Lean
...
## 🏛️ Partie 4 :  Gouvernance et Cycle de Vie d'un Projet
...
### 4.1 Hiérarchie des Documents et Responsabilités
...
### 4.2 Cadre Opérationnel : Responsabilités, Rituels et Traçabilité
...
### 4.3 Cycle de Vie des Spécifications (Flux Agile)
...
### 4.4 Changelog Global - Historique des révisions des documents du projet
...
### 4.5 Changelog interne - Historique des révisions d'un document spécifique
